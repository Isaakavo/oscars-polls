...
import {PlusOutlined, CopyOutlined, TrophyFilled} from '@ant-design/icons';
...
export const Leaderboard = () => {
    ...
    const getRankIcon = (index: number) => {
        switch (index) {
            case 0:
                return <TrophyFilled style={{color: '#FFD700', fontSize: 24}}/>;
            case 1:
                return <TrophyFilled style={{color: '#C0C0C0', fontSize: 20}}/>;
            case 2:
                return <TrophyFilled style={{color: '#CD7F32', fontSize: 18}}/>;
            default:
                return <Text strong style={{color: '#666', fontSize: 16}}>#{index + 1}</Text>;
        }
    };
                ...
                {selectedGroupId && currentGroup ? (
                    <>
                        <Alert
                            ...
                            description={
                                <Button type="link" size="small" icon={<CopyOutlined/>} onClick={copyInviteLink}
                                        style={{padding: 0}}>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <List.Item.Meta
                                            ...
                                            description={<Text type="secondary">{item.totalVotes} predicciones
                                                realizadas</Text>}
                                        />
                    ...
                    <Alert
                        title="Selecciona un grupo para ver los marcadores. Si no estas en un grupo, puedes crear uno o unirte a uno ya existente"
                    />
                </>}
